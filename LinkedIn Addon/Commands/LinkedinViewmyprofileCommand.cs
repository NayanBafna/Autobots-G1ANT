...
{
    [Command(Name = "linkedin.viewmyprofile", Tooltip = "This command is used for viewing your own linkedin profile.")]
    public class LinkedinViewmyprofileCommand : Command
    {
        public LinkedinViewmyprofileCommand(AbstractScripter scripter) : base(scripter)
        {
