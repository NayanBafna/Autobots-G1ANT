...
namespace G1ANT.Addon.TripAdvisor
{
    ...
    class TripAdvisorSearchFlightCommand : Command
    {
        public TripAdvisorSearchFlightCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                Thread.Sleep(10000);
                arguments.Search.Value = "/html/body/div[2]/div/div/div[4]/div/div[1]/div/div/div/div[2]";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value);
