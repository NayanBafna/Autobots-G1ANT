...
{
    [Command(Name = "whatsappweb.viewblockedcontacts", Tooltip = "This command is used for viewing Blocked Contacts of your whatsapp account.")]
    public class WhatsappWebViewBlockedContactsCommand : Command
    {
        public WhatsappWebViewBlockedContactsCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value);
                System.Threading.Thread.Sleep(6000);
                arguments.Search.Value = "/html/body/div[1]/div/div/div[2]/div[1]/span/div/span/div/div/div[5]/div[2]";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value);
