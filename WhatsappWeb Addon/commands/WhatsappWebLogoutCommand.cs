...
{
    [Command(Name = "whatsappweb.logout", Tooltip = "This command is used for logoout from your whatsapp account.")]
    public class WhatsappWebLogoutCommand : Command
    {
        public WhatsappWebLogoutCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                arguments.Search.Value = "/html/body/div[1]/div/div/div[3]/div/header/div[2]/div/span/div[3]/span/div/ul/li[6]/div";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value);
