...
{
    [Command(Name = "whatsappweb.viewarchivedchats", Tooltip = "This command is used for viewing ArchievedChats of your whatsapp account.")]
    public class WhatsappWebViewArchievedChatsCommand : Command
    {
        public WhatsappWebViewArchievedChatsCommand(AbstractScripter scripter) : base(scripter)
        {
