...
{
    [Command(Name = "telegram.info", Tooltip = "This command is used for viewing info in telegram account.")]
    public class TelegramInfoCommand : Command
    {
        public TelegramInfoCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments, string attributeValue)
        {
            try
            {
                ...
                arguments.Search.Value = "/html/body/div[1]/div[1]/div/div/div[1]/div/ul/li[4]/a";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value);
                System.Threading.Thread.Sleep(6000);
