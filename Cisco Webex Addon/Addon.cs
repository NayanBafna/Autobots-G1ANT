...
using G1ANT.Addon.Webex.Properties;
using System.IO;

namespace G1ANT.Addon.Webex
{
    [Addon(Name = "webex", Tooltip = "Automates the webex site")]
    [Copyright(Author = "", Copyright = "", Email = "support@g1ant.com", Website = "www.g1ant.com")]
    [License(Type = "LGPL", ResourceName = "License.txt")]
    [CommandGroup(Name = "webex", Tooltip = "")]
    public class WebexAddon : Language.Addon
    {
