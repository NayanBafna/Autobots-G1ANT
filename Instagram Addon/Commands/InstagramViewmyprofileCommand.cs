...
{
    [Command(Name = "instagram.viewmyprofile", Tooltip = "This command is used to view your own profile on the instagram site.")]
    public class InstagramViewmyprofileCommand : Command
    {
        public InstagramViewmyprofileCommand(AbstractScripter scripter) : base(scripter)
        {
