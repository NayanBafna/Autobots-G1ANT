...
{
    [Command(Name = "instagram.getfollowing", Tooltip = "This command is used to all your following on instagram.")]
    public class InstagramGetfollowingCommand : Command
    {
        public InstagramGetfollowingCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value);
                arguments.Search.Value = "/html[1]/body[1]/div[1]/section[1]/main[1]/div[1]/header[1]/section[1]/ul[1]/li[3]/a[1]";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value);
             ...
             arguments.Timeout.Value);
                ...
                arguments.Search.Value = "/html[1]/body[1]/div[4]/div[1]/div[1]/div[1]/div[1]/div[2]/button[1]/div[1]/*[local-name()='svg'][1]/*[name()='path'][1]";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value);
