...
{
    [Command(Name = "instagram.getallmessages", Tooltip = "This command is used to get all messages from your instagram account.")]
    public class InstagramGetallmessagesCommand : Command
    {
        public InstagramGetallmessagesCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                arguments.Search.Value = "/html[1]/body[1]/div[1]/section[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]";
                arguments.By.Value = "xpath";
