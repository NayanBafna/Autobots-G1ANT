...
{
    [Command(Name = "instagram.follow", Tooltip = "This command is used to follow any profile on the instagram site.")]
    class InstagramFollowCommand : Command
    {
        ...
        public class Arguments : SeleniumCommandArguments
        {
            ...
            [Argument(Required = true, Tooltip = "private or public")]
            public TextStructure accounttype { get; set; }
        ...
        public void Execute(Arguments arguments)
        {
            try
            {
                var p = arguments.accounttype.Value;
                if (p == "private")
                {
                    ...
                    arguments.Search.Value = "/html[1]/body[1]/div[1]/section[1]/main[1]/div[1]/header[1]/section[1]/div[1]/button[1]";
                ...
                if (p== "public")
                {
                    ...
                    SeleniumManager.CurrentWrapper.NewTab(arguments.Timeout.Value, URL, true);
                    System.Threading.Thread.Sleep(10000);
                    arguments.Search.Value = "/html[1]/body[1]/div[1]/section[1]/main[1]/div[1]/header[1]/section[1]/div[1]/div[1]/span[1]/span[1]/button[1]";
                    arguments.By.Value = "xpath";
                    SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value);
                }
