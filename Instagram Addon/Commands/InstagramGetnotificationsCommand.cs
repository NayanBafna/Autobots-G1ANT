...
{
    [Command(Name = "instagram.getnotifications", Tooltip = "This command is used to get all notifications from instagram.")]
    public class InstagramGetnotificationsCommand : Command
    {
        public InstagramGetnotificationsCommand(AbstractScripter scripter) : base(scripter)
        {
