...
{
    [Command(Name = "twitter.getmytweets", Tooltip = "This command is used to get all the tweets posted by you from your twitter account.")]
    public class TwitterGetmytweetsCommand : Command
    {
        public TwitterGetmytweetsCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                arguments.Search.Value = "#react-root > div > div > div.css-1dbjc4n.r-18u37iz.r-13qz1uu.r-417010 > main > div > div > div > div > div > div:nth-child(2) > div > div > div:nth-child(3) > section > div > div";
