...
{
    [Command(Name = "twitter.opentweet", Tooltip = "This command is used to open any tweet on twitter site.")]
    public class TwitterOpentweetCommand : Command
    {
        public TwitterOpentweetCommand(AbstractScripter scripter) : base(scripter)
        {
