...
{
    [Command(Name = "twitter.getfollowers", Tooltip = "This command is used to get all followers from your twitter account.")]
    public class TwitterGetfollowersCommand : Command
    {
        public TwitterGetfollowersCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                arguments.Search.Value = "/html[1]/body[1]/div[1]/div[1]/div[1]/div[2]/main[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/div[4]/div[2]/a[1]/span[2]/span[1]";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value);
                System.Threading.Thread.Sleep(2000);
